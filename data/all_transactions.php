    ...
    <table id="myTable-txn" class="table table-bordered table-hover">
        <thead>
            <tr>
                ...
                <th style="width:40px;"><input type="checkbox" id="select-all-txn"></th>
                <?php endif; ?>
                <th>Reference</th>
                <th>Customer</th>
                ...
                <th><center>Processed By</center></th>
                <th style="width:140px;"><center>Action</center></th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                <?php if($userRole == 'admin'): ?>
                <td><center><input type="checkbox" class="select-txn" value="<?= $r['sale_id']; ?>" data-amount="<?= $r['sale_total']; ?>"></center></td>
                <?php endif; ?>
                ...
                <td><center><span style="background:rgba(99,102,241,0.15);color:#818cf8;padding:3px 10px;border-radius:20px;font-size:11px;font-weight:600;"><?= $r['sale_payment_method']; ?></span></center></td>
                <td><center><span style="font-weight:600; color:#10b981;">₱<?= number_format($r['sale_total'], 2); ?></span></center></td>
                <td><center><span style="font-size:12px; color:#94a3b8;"><?= date('M d, Y h:i A', strtotime($r['sale_date'])); ?></span></center></td>
                <td><center><span style="font-size:12px; color:#94a3b8;">
                    <?php 
